...
- [ ] 1. Setup database schema for purchase orders
  - [ ] 1.1 Create SQL migration file for suppliers, purchase_orders, and purchase_order_items tables
...
- [ ] 6. Implement Receive PO and Stock Update
  - [ ] 6.1 Create receive purchase order function
...
- [ ] 8. Build Purchase Order UI Components
  ...
  - [ ] 8.5 Create PO Detail component
...
- [ ] 9. Build Purchase Order Page
  - [ ] 9.1 Create main Pemesanan page
    - Integrate all PO components
    - Add state management for selected PO and modals
    - _Requirements: 2.1_
  - [ ] 9.2 Update App.tsx routing
